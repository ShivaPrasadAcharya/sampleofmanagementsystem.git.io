...
• **Transactional relationship**: Pay money, receive product/service
• **Exit option**: Unhappy customers can switch to competitors
• **Individual satisfaction**: Primary goal is personal value and satisfaction
• **Example**: Netflix subscribers can cancel and switch to Disney+ if dissatisfied

### Citizen-Government Model
• **Constitutional relationship**: Based on rights, duties, and shared destiny
• **Voice, not exit**: Citizens must engage through democratic processes, not market switching
• **Collective good**: Balances individual needs with societal welfare
• **Real Case**: During COVID-19 lockdowns, many citizens were dissatisfied with restrictions, but couldn't "switch governments" - they had to engage through democratic processes to influence policy

## 2. Rights vs. Preferences

### Consumer Preferences
• Want better features, lower prices, improved service
• Business failure = disappointment and inconvenience

### Citizen Rights
• Constitutional guarantees: due process, equal protection, voting, free speech
• Government failure = violation of fundamental rights
• **Real Case**: In *Brown v. Board of Education* (1954), school desegregation had extremely low "customer satisfaction" among white communities, but the Supreme Court ruled it was a constitutional right that couldn't be subject to popular opinion or satisfaction scores

## 3. Complex "Products" and Public Stakeholders

### Business Products
• Clear, tangible products (phones, meals, flights)
• Shareholders seek profit maximization

### Government "Products"
• Intangible, complex services: justice, security, regulation, public health
• Citizens are both "customers" and "shareholders"
• **Real Case**: The FDA's ban on trans fats in food (2015) was highly unpopular with food manufacturers and some consumers who preferred taste over health, but protecting public health was the government's duty regardless of "customer satisfaction"

### Environmental Protection Example
• **EPA's Clean Air Act enforcement** often frustrates businesses and some communities due to compliance costs
• A consumer model would prioritize satisfying these vocal "customers"
• But the EPA's job is protecting public health for current and future generations, not maximizing satisfaction

## 4. Tyranny of the Majority vs. Minority Protection

### Consumer Model Problem
• Aims to please the largest number of paying customers
• Majority satisfaction becomes the primary metric

### Democratic Governance Reality
• Must protect minority rights even when unpopular with the majority
• **Real Cases**:
...
### Business Focus
• Quarterly returns and immediate customer satisfaction
• Consumer decisions based on immediate needs

### Government Responsibility
• Multi-generational planning and sustainable policies
• **Real Cases**:
...
• **Boston's Big Dig project**: Caused 20+ years of traffic disruption and cost overruns
• Consumer satisfaction was extremely low during construction
• But created lasting infrastructure benefits that a market-driven approach would never have attempted

## 6. Monopoly vs. Choice Problem

### Consumer Markets
• Multiple competitors provide choice and alternatives
• Market forces drive improvement

### Government Services
• Natural monopoly on legitimate force and essential services
• No alternative police, courts, or military to "shop" for
• **Real Case**: During Hurricane Katrina (2005), citizens couldn't choose alternative emergency response services when FEMA failed - they had to work within the existing system

## 7. Problems with NPS/NPG Metrics in Government

### Complexity Reduction Issues
• **Real Case**: Department of Veterans Affairs healthcare
...
• **Education**: Schools might focus on popular programs that boost parent satisfaction rather than challenging curricula that prepare students for complex careers
• **Public health**: Agencies might avoid unpopular but necessary interventions (like mask mandates) to maintain high satisfaction scores

## 8. When Customer Service Models Are Appropriate

### Transactional Government Services
• **DMV operations**: Wait times, courtesy, online services
• **Building permits**: Processing speed, clear requirements
• **Public libraries**: Hours, accessibility, collection quality
• **Real improvement example**: Estonia's digital government services achieved high satisfaction through user-friendly design while maintaining democratic accountability

### Service Delivery Success Cases
• **Singapore's government digital services**: High satisfaction through efficient online platforms
• **Key difference**: These improvements enhanced service delivery without compromising democratic principles or long-term governance

## 9. Historical Examples of Consumer Model Failures

### New Public Management Era (1980s-2000s)
• Attempted to run government "like a business"
• **UK Rail Privatization**: Prioritized customer satisfaction and profit but led to safety issues and reduced service to less profitable areas
• **US Welfare Reform**: Market-oriented approach reduced costs but didn't address root causes of poverty

### Market-Based Education Reforms
• **Charter school movement**: Applied consumer choice model to education
• Results showed that parent "satisfaction" didn't correlate with student academic outcomes
• Market competition didn't automatically improve educational quality

## 10. The Democratic Alternative

### Accountability Through Democracy, Not Markets
• **Citizen engagement**: Town halls, public hearings, democratic elections
• **Transparency**: Freedom of Information laws, open government initiatives
• **Long-term stewardship**: Constitutional protections and institutional safeguards

### Real Success Examples
• **Participatory budgeting**: Cities like Porto Alegre, Brazil, engage citizens in budget decisions
• **Citizens' assemblies**: Ireland used citizen panels to address abortion and same-sex marriage
• **These approaches maintain democratic legitimacy while improving government responsiveness**
